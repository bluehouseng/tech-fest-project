...
//         </p>
//         <button className="bg-gradient-to-tl from-green-300 to-green-900 px-6 sm:px-8 md:px-10 py-2 rounded-full text-white cursor-pointer transition-all duration-300 hover:from-green-400 hover:to-green-800 hover:shadow-lg transform hover:scale-105 text-sm sm:text-base">
//           Join the Channel
//         </button>
//       </div>
//     </div>
...
//                 >
//                   <div
//                     className={`transition-all duration-300 ease-in-out bg-white shadow-lg rounded-lg text-center border h-72 sm:h-80 md:h-84 w-full max-w-xs sm:max-w-sm overflow-hidden ${
//                       index === activeIndex
