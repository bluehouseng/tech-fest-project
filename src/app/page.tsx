...
export default function Landing() {
  return (
    ...
    <main className="min-h-screen w-full bg-gradient-to-b from-white via-[#f6f6f4] to-[#eef7f1] relative overflow-hidden">
      {/* Header */}
...
//           {["home", "about", "community", "speakers", "contact"].map((link) => (
//             <Link
//               key={link}
//               href={`/${link === "home" ? "" : link}`}
//               className="capitalize text-gray-700 hover:text-amber-500 transition"
//             >
//               {link}
//             </Link>
//           ))}
...
//         <Link
//           href="/register"
//           className="hidden md:inline-block bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-amber-500 transition"
//         >
//           Register Now
//         </Link>
...
//       {/* Mobile Dropdown */}
//       {open && (
//         <div className="md:hidden flex flex-col items-center bg-white shadow-lg py-4 space-y-4">
//           {["home", "about", "community", "speakers", "contact"].map((link) => (
//             <Link
//               key={link}
//               href={`/${link === "home" ? "" : link}`}
...
//           <Link
//             href="/register"
//             className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-amber-500 transition"
//             onClick={() => setOpen(false)}
//           >
//             Register Now
//           </Link>
