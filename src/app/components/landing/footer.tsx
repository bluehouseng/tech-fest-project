...
//   return (
//     <footer className="bg-[#f5f5f4] text-gray-700 pt-12 pb-6  md:mx-2">
//       <div className="max-w-7xl mx-auto px-16 grid grid-cols-1 md:grid-cols-4 ">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 grid grid-cols-1 md:grid-cols-4 gap-y-8 gap-x-8 items-start">
        ...
        <div className="flex flex-col items-start">
          ...
          <form className="mt-4 flex w-full">
            ...
            <button
              type="submit"
              className="px-4 py-2 bg-green-900 text-white text-sm rounded-r-lg hover:bg-amber-500 transition"
            >
              Subscribe
            </button>
          </form>
